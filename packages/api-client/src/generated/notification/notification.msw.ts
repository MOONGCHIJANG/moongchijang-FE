...
export const getPatchApiV1NotificationsReadAllMockHandler = (overrideResponse?: SuccessNoDataResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<SuccessNoDataResponse> | SuccessNoDataResponse), options?: RequestHandlerOptions) => {
  return http.patch('*/api/v1/notifications/read-all', async (info: Parameters<Parameters<typeof http.patch>[1]>[0]) => {
...
export const getPatchApiV1NotificationsNotificationIdReadMockHandler = (overrideResponse?: SuccessNoDataResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<SuccessNoDataResponse> | SuccessNoDataResponse), options?: RequestHandlerOptions) => {
