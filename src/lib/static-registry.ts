...
export const STATIC_FALLBACK: Record<string, StaticLoader> = {
  '/api/v1/group-buys': () => import('../../mocks/data/group-buys.json').then((m) => m.default),
  '/api/v1/group-buys/1': () => import('../../mocks/data/group-buy-detail-1.json').then((m) => m.default),
  '/api/v1/group-buys/2': () => import('../../mocks/data/group-buy-detail-2.json').then((m) => m.default),
  '/api/v1/group-buys/3': () => import('../../mocks/data/group-buy-detail-3.json').then((m) => m.default),
  '/api/v1/group-buys/4': () => import('../../mocks/data/group-buy-detail-4.json').then((m) => m.default),
  '/api/v1/group-buys/5': () => import('../../mocks/data/group-buy-detail-5.json').then((m) => m.default),
};
