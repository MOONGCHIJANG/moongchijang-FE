...
} from '@moongchijang/api-client/hooks/my-page/my-page';
import {
...
import { useGetApiV1ParticipationsParticipationIdPickup } from '@moongchijang/api-client/hooks/pickup/pickup';
