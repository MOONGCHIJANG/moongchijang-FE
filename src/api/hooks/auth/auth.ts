...
export const getDeleteApiV1UsersMeMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiV1UsersMe>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ...
 * @summary 회원 탈퇴
 */
export const useDeleteApiV1UsersMe = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiV1UsersMe>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getPostApiV1AuthPasswordResetLinkMutationOptions = <TError = NotFoundResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthPasswordResetLink>>, TError,{data: PasswordResetLinkRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthPasswordResetLink>>, TError,{data: PasswordResetLinkRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1AuthPasswordResetLink>>, {data: PasswordResetLinkRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1AuthPasswordResetLinkMutationResult = NonNullable<Awaited<ReturnType<typeof postApiV1AuthPasswordResetLink>>>
    export type PostApiV1AuthPasswordResetLinkMutationBody = PasswordResetLinkRequest
    export type PostApiV1AuthPasswordResetLinkMutationError = NotFoundResponse

    /**
 * @summary 비밀번호 재설정 링크 발송
 */
export const usePostApiV1AuthPasswordResetLink = <TError = NotFoundResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthPasswordResetLink>>, TError,{data: PasswordResetLinkRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostApiV1AuthPasswordResetLinkMutationOptions(options), queryClient);
    }
    /**
 * 닉네임과 전화번호를 수정한다.
 * @summary 프로필 수정
...
export const getPatchApiV1UsersMeProfileMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiV1UsersMeProfile>>, TError,{data: ProfileUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof patchApiV1UsersMeProfile>>, TError,{data: ProfileUpdateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof patchApiV1UsersMeProfile>>, {data: ProfileUpdateRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchApiV1UsersMeProfileMutationResult = NonNullable<Awaited<ReturnType<typeof patchApiV1UsersMeProfile>>>
    export type PatchApiV1UsersMeProfileMutationBody = ProfileUpdateRequest
    export type PatchApiV1UsersMeProfileMutationError = BadRequestResponse | UnauthorizedResponse | ConflictResponse

    /**
 * @summary 프로필 수정
 */
export const usePatchApiV1UsersMeProfile = <TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiV1UsersMeProfile>>, TError,{data: ProfileUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPatchApiV1UsersMeProfileMutationOptions(options), queryClient);
    }
    /**
...
export const getPostApiV1AuthPasswordChangeMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | ForbiddenResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthPasswordChange>>, TError,{data: PasswordChangeRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthPasswordChange>>, TError,{data: PasswordChangeRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1AuthPasswordChange>>, {data: PasswordChangeRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1AuthPasswordChangeMutationResult = NonNullable<Awaited<ReturnType<typeof postApiV1AuthPasswordChange>>>
    export type PostApiV1AuthPasswordChangeMutationBody = PasswordChangeRequest
    export type PostApiV1AuthPasswordChangeMutationError = BadRequestResponse | UnauthorizedResponse | ForbiddenResponse

    /**
 * @summary 비밀번호 변경 (이메일 가입자 전용)
 */
export const usePostApiV1AuthPasswordChange = <TError = BadRequestResponse | UnauthorizedResponse | ForbiddenResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1AuthPasswordChange>>, TError,{data: PasswordChangeRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostApiV1AuthPasswordChangeMutationOptions(options), queryClient);
    }
    /**
 * @summary 내 관심 지역 조회
 */
