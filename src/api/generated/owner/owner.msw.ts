...
export const getGetApiV1OwnerGroupBuyRequestsResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseOwnerGroupBuyRequestList, object>
  > = {},
): ApiResponseOwnerGroupBuyRequestList => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getPostApiV1OwnerGroupBuyRequestsResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseOwnerGroupBuyRequestCreated, object>
  > = {},
): ApiResponseOwnerGroupBuyRequestCreated => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getGetApiV1OwnerGroupBuyRequestsRequestIdResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseOwnerGroupBuyRequestDetail, object>
  > = {},
): ApiResponseOwnerGroupBuyRequestDetail => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getGetApiV1OwnerGroupBuyRequestsMockHandler = (
  overrideResponse?:
    ...
    | ((
        ...
        | Promise<ApiResponseOwnerGroupBuyRequestList>
        | ApiResponseOwnerGroupBuyRequestList),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getPostApiV1OwnerGroupBuyRequestsMockHandler = (
  overrideResponse?:
    | ApiResponseOwnerGroupBuyRequestCreated
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) =>
        | Promise<ApiResponseOwnerGroupBuyRequestCreated>
        | ApiResponseOwnerGroupBuyRequestCreated),
  options?: RequestHandlerOptions,
) => {
  return http.post(
...
export const getGetApiV1OwnerGroupBuyRequestsRequestIdMockHandler = (
  overrideResponse?:
    | ApiResponseOwnerGroupBuyRequestDetail
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<ApiResponseOwnerGroupBuyRequestDetail>
        | ApiResponseOwnerGroupBuyRequestDetail),
  options?: RequestHandlerOptions,
) => {
  return http.get(
