...
export const getPostApiV1PickupsQrCodeVerifyMutationOptions = <TError = BadRequestResponse | ForbiddenResponse | ConflictResponse,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1PickupsQrCodeVerifyMutationError = BadRequestResponse | ForbiddenResponse | ConflictResponse

    /**
 * @summary QR 코드 스캔 검증 및 수령 처리
 */
export const usePostApiV1PickupsQrCodeVerify = <TError = BadRequestResponse | ForbiddenResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1PickupsQrCodeVerify>>, TError,{qrCode: string}, TContext>, request?: SecondParameter<typeof customFetch>}
