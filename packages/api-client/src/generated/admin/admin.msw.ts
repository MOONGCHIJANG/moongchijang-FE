...
export const getGetApiV1AdminDashboardUrgentRefundsResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminDashboardUrgentRefunds, object>> = {}): ApiResponseAdminDashboardUrgentRefunds => ({success: faker.datatype.boolean(), data: {totalUrgentCount: faker.number.int(), hasUrgentRefunds: faker.datatype.boolean(), content: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({requestId: faker.number.int(), caseFilter: faker.helpers.arrayElement(['ALL','PRE_ACHIEVEMENT_FREE_CANCEL','POST_ACHIEVEMENT_CANCEL','PICKUP_PERIOD_NO_SHOW','OWNER_FAULT_CANCEL','TARGET_NOT_MET','DISPUTE_OR_DROPOUT_REFUND'] as const), consumerName: faker.string.alpha({length: {min: 10, max: 20}}), groupBuyName: faker.string.alpha({length: {min: 10, max: 20}}), refundAmount: faker.number.int(), requestedAt: faker.date.past().toISOString().slice(0, 19) + 'Z', slaElapsedHours: faker.number.int()})), totalElements: faker.number.int(), totalPages: faker.number.int(), number: faker.number.int(), size: faker.number.int()}, error: {}, ...overrideResponse})
...
export const getGetApiV1AdminOrdersOrderIdResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOrderDetail, object>> = {}): ApiResponseAdminOrderDetail => ({success: faker.datatype.boolean(), data: {orderId: faker.number.int(), groupBuyId: faker.number.int(), productName: faker.string.alpha({length: {min: 10, max: 20}}), productDescription: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}}), storeAddress: faker.string.alpha({length: {min: 10, max: 20}}), storePhoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), achievedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), finalQuantity: faker.number.int(), targetQuantity: faker.number.int(), pendingRefundCount: faker.number.int(), pendingRefundNoticeRequired: faker.datatype.boolean(), pickupDate: faker.date.past().toISOString().slice(0, 10), pickupTimeStart: faker.string.alpha({length: {min: 10, max: 20}}), pickupTimeEnd: faker.string.alpha({length: {min: 10, max: 20}}), pickupLocation: faker.string.alpha({length: {min: 10, max: 20}}), pickupContact: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), elapsedHours: faker.number.int(), progressRate: faker.number.int(), orderStatus: faker.helpers.arrayElement(['PENDING','CONFIRMED','CANCELLED'] as const), ownerContactedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderConfirmedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderCancelledAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean(), notificationHistories: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({historyId: faker.number.int(), triggerType: faker.helpers.arrayElement(['OWNER_ORDER_CONFIRM_REQUIRED_IMMEDIATE','OWNER_ORDER_CANCELLED_IMMEDIATE'] as const), scheduleKey: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(['PENDING','SUCCESS','FAILED'] as const), retryCount: faker.number.int(), processedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), lastError: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}))}, error: {}, ...overrideResponse})

export const getPostApiV1AdminOrdersOrderIdOwnerContactResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOrderDetail, object>> = {}): ApiResponseAdminOrderDetail => ({success: faker.datatype.boolean(), data: {orderId: faker.number.int(), groupBuyId: faker.number.int(), productName: faker.string.alpha({length: {min: 10, max: 20}}), productDescription: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}}), storeAddress: faker.string.alpha({length: {min: 10, max: 20}}), storePhoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), achievedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), finalQuantity: faker.number.int(), targetQuantity: faker.number.int(), pendingRefundCount: faker.number.int(), pendingRefundNoticeRequired: faker.datatype.boolean(), pickupDate: faker.date.past().toISOString().slice(0, 10), pickupTimeStart: faker.string.alpha({length: {min: 10, max: 20}}), pickupTimeEnd: faker.string.alpha({length: {min: 10, max: 20}}), pickupLocation: faker.string.alpha({length: {min: 10, max: 20}}), pickupContact: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), elapsedHours: faker.number.int(), progressRate: faker.number.int(), orderStatus: faker.helpers.arrayElement(['PENDING','CONFIRMED','CANCELLED'] as const), ownerContactedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderConfirmedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderCancelledAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean(), notificationHistories: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({historyId: faker.number.int(), triggerType: faker.helpers.arrayElement(['OWNER_ORDER_CONFIRM_REQUIRED_IMMEDIATE','OWNER_ORDER_CANCELLED_IMMEDIATE'] as const), scheduleKey: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(['PENDING','SUCCESS','FAILED'] as const), retryCount: faker.number.int(), processedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), lastError: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}))}, error: {}, ...overrideResponse})

export const getPostApiV1AdminOrdersOrderIdConfirmResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOrderDetail, object>> = {}): ApiResponseAdminOrderDetail => ({success: faker.datatype.boolean(), data: {orderId: faker.number.int(), groupBuyId: faker.number.int(), productName: faker.string.alpha({length: {min: 10, max: 20}}), productDescription: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}}), storeAddress: faker.string.alpha({length: {min: 10, max: 20}}), storePhoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), achievedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), finalQuantity: faker.number.int(), targetQuantity: faker.number.int(), pendingRefundCount: faker.number.int(), pendingRefundNoticeRequired: faker.datatype.boolean(), pickupDate: faker.date.past().toISOString().slice(0, 10), pickupTimeStart: faker.string.alpha({length: {min: 10, max: 20}}), pickupTimeEnd: faker.string.alpha({length: {min: 10, max: 20}}), pickupLocation: faker.string.alpha({length: {min: 10, max: 20}}), pickupContact: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), elapsedHours: faker.number.int(), progressRate: faker.number.int(), orderStatus: faker.helpers.arrayElement(['PENDING','CONFIRMED','CANCELLED'] as const), ownerContactedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderConfirmedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderCancelledAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean(), notificationHistories: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({historyId: faker.number.int(), triggerType: faker.helpers.arrayElement(['OWNER_ORDER_CONFIRM_REQUIRED_IMMEDIATE','OWNER_ORDER_CANCELLED_IMMEDIATE'] as const), scheduleKey: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(['PENDING','SUCCESS','FAILED'] as const), retryCount: faker.number.int(), processedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), lastError: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}))}, error: {}, ...overrideResponse})

export const getPostApiV1AdminOrdersOrderIdCancelResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOrderDetail, object>> = {}): ApiResponseAdminOrderDetail => ({success: faker.datatype.boolean(), data: {orderId: faker.number.int(), groupBuyId: faker.number.int(), productName: faker.string.alpha({length: {min: 10, max: 20}}), productDescription: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}}), storeAddress: faker.string.alpha({length: {min: 10, max: 20}}), storePhoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), achievedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), finalQuantity: faker.number.int(), targetQuantity: faker.number.int(), pendingRefundCount: faker.number.int(), pendingRefundNoticeRequired: faker.datatype.boolean(), pickupDate: faker.date.past().toISOString().slice(0, 10), pickupTimeStart: faker.string.alpha({length: {min: 10, max: 20}}), pickupTimeEnd: faker.string.alpha({length: {min: 10, max: 20}}), pickupLocation: faker.string.alpha({length: {min: 10, max: 20}}), pickupContact: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), elapsedHours: faker.number.int(), progressRate: faker.number.int(), orderStatus: faker.helpers.arrayElement(['PENDING','CONFIRMED','CANCELLED'] as const), ownerContactedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderConfirmedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), orderCancelledAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean(), notificationHistories: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({historyId: faker.number.int(), triggerType: faker.helpers.arrayElement(['OWNER_ORDER_CONFIRM_REQUIRED_IMMEDIATE','OWNER_ORDER_CANCELLED_IMMEDIATE'] as const), scheduleKey: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(['PENDING','SUCCESS','FAILED'] as const), retryCount: faker.number.int(), processedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), lastError: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}))}, error: {}, ...overrideResponse})

export const getGetApiV1AdminCsTicketsResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminCsTicketPage, object>> = {}): ApiResponseAdminCsTicketPage => ({success: faker.datatype.boolean(), data: {content: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({ticketId: faker.number.int(), type: faker.helpers.arrayElement(['REFUND','ORDER','PICKUP','ACCOUNT','ETC'] as const), title: faker.string.alpha({length: {min: 10, max: 20}}), consumerId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), consumerName: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), groupBuyId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), groupBuyName: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), priority: faker.helpers.arrayElement(['LOW','MEDIUM','HIGH','URGENT'] as const), assigneeName: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), createdAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), slaHours: faker.number.int(), status: faker.helpers.arrayElement(['RECEIVED','IN_PROGRESS','COMPLETED'] as const), actionable: faker.datatype.boolean()})), totalElements: faker.number.int(), totalPages: faker.number.int(), number: faker.number.int(), size: faker.number.int()}, error: {}, ...overrideResponse})

export const getGetApiV1AdminCsTicketsTicketIdResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminCsTicketDetail, object>> = {}): ApiResponseAdminCsTicketDetail => ({success: faker.datatype.boolean(), data: {ticketId: faker.number.int(), type: faker.helpers.arrayElement(['REFUND','ORDER','PICKUP','ACCOUNT','ETC'] as const), title: faker.string.alpha({length: {min: 10, max: 20}}), description: faker.string.alpha({length: {min: 10, max: 20}}), priority: faker.helpers.arrayElement(['LOW','MEDIUM','HIGH','URGENT'] as const), status: faker.helpers.arrayElement(['RECEIVED','IN_PROGRESS','COMPLETED'] as const), createdAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), updatedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), slaHours: faker.number.int(), consumer: faker.helpers.arrayElement([{...{userId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), nickname: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), email: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), phoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])},}, null]), owner: faker.helpers.arrayElement([{...{storeId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), storePhoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])},}, null]), groupBuy: faker.helpers.arrayElement([{...{groupBuyId: faker.number.int(), productName: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}})},}, null]), refundParticipationId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), assigneeName: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), processingMemo: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), resolvedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean()}, error: {}, ...overrideResponse})

export const getPatchApiV1AdminCsTicketsTicketIdResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminCsTicketDetail, object>> = {}): ApiResponseAdminCsTicketDetail => ({success: faker.datatype.boolean(), data: {ticketId: faker.number.int(), type: faker.helpers.arrayElement(['REFUND','ORDER','PICKUP','ACCOUNT','ETC'] as const), title: faker.string.alpha({length: {min: 10, max: 20}}), description: faker.string.alpha({length: {min: 10, max: 20}}), priority: faker.helpers.arrayElement(['LOW','MEDIUM','HIGH','URGENT'] as const), status: faker.helpers.arrayElement(['RECEIVED','IN_PROGRESS','COMPLETED'] as const), createdAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), updatedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), slaHours: faker.number.int(), consumer: faker.helpers.arrayElement([{...{userId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), nickname: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), email: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), phoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])},}, null]), owner: faker.helpers.arrayElement([{...{storeId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), storePhoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])},}, null]), groupBuy: faker.helpers.arrayElement([{...{groupBuyId: faker.number.int(), productName: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}})},}, null]), refundParticipationId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), assigneeName: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), processingMemo: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), resolvedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean()}, error: {}, ...overrideResponse})

export const getPostApiV1AdminOwnerGroupBuysGroupBuyIdCloseRequestsApproveResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOwnerGroupBuyCloseRequestAction, object>> = {}): ApiResponseAdminOwnerGroupBuyCloseRequestAction => ({success: faker.datatype.boolean(), data: {groupBuyId: faker.number.int(), reviewStatus: faker.helpers.arrayElement(Object.values(GroupBuyCloseRequestReviewStatus)), groupBuyStatus: faker.helpers.arrayElement(['IN_PROGRESS','ACHIEVED','COMPLETED','FAILED','CLOSED'] as const)}, error: {}, ...overrideResponse})
...
export const getGetApiV1AdminOwnerGroupBuyRequestsResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOwnerGroupBuyRequestPage, object>> = {}): ApiResponseAdminOwnerGroupBuyRequestPage => ({success: faker.datatype.boolean(), data: {content: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({requestId: faker.number.int(), requestType: faker.helpers.arrayElement(['OWNER'] as const), productName: faker.string.alpha({length: {min: 10, max: 20}}), storeName: faker.string.alpha({length: {min: 10, max: 20}}), ownerName: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), originalPrice: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), null]), price: faker.number.int(), discountRate: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), targetQuantity: faker.number.int(), pickupDate: faker.date.past().toISOString().slice(0, 10), requestedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), reviewElapsedMinutes: faker.number.int(), status: faker.helpers.arrayElement(['PENDING','APPROVED','REJECTED'] as const), actionable: faker.datatype.boolean(), approvedGroupBuyId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined])})), totalElements: faker.number.int(), totalPages: faker.number.int(), number: faker.number.int(), size: faker.number.int()}, error: {}, ...overrideResponse})

export const getGetApiV1AdminOwnerGroupBuyRequestsRequestIdResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOwnerGroupBuyRequestDetail, object>> = {}): ApiResponseAdminOwnerGroupBuyRequestDetail => ({success: faker.datatype.boolean(), data: {requestId: faker.number.int(), requestType: faker.helpers.arrayElement(['OWNER'] as const), status: faker.helpers.arrayElement(['PENDING','APPROVED','REJECTED'] as const), owner: {ownerId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), nickname: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), phoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), email: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}, store: {storeId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), address: faker.string.alpha({length: {min: 10, max: 20}}), phoneNumber: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}, product: {productName: faker.string.alpha({length: {min: 10, max: 20}}), productDescription: faker.string.alpha({length: {min: 10, max: 20}}), originalPrice: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), price: faker.number.int(), discountRate: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), targetQuantity: faker.number.int(), maxQuantity: faker.number.int(), perUserLimit: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined])}, recruitment: {recruitmentStartAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), deadline: faker.date.past().toISOString().slice(0, 19) + 'Z', pickupDate: faker.date.past().toISOString().slice(0, 10), pickupTimeStart: faker.string.alpha({length: {min: 10, max: 20}}), pickupTimeEnd: faker.string.alpha({length: {min: 10, max: 20}}), pickupLocation: faker.string.alpha({length: {min: 10, max: 20}}), pickupContact: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])}, images: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({imageUrl: faker.string.alpha({length: {min: 10, max: 20}}), sortOrder: faker.number.int()})), imageCount: faker.number.int(), rejectionReason: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 200}}), null]), undefined]), approvedGroupBuyId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), reviewedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), requestedAt: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', null]), undefined]), actionable: faker.datatype.boolean()}, error: {}, ...overrideResponse})

export const getPostApiV1AdminOwnerGroupBuyRequestsRequestIdApproveResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminOwnerGroupBuyRequestAction, object>> = {}): ApiResponseAdminOwnerGroupBuyRequestAction => ({success: faker.datatype.boolean(), data: {requestId: faker.number.int(), status: faker.helpers.arrayElement(['APPROVED','REJECTED'] as const), groupBuyId: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(), null]), undefined]), approvalSummary: faker.helpers.arrayElement([{...{productName: faker.string.alpha({length: {min: 10, max: 20}}), price: faker.number.int(), targetQuantity: faker.number.int(), pickupDate: faker.date.past().toISOString().slice(0, 10), imageCount: faker.number.int()},}, null])}, error: {}, ...overrideResponse})
...
export const getGetApiV1AdminSettlementsResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminSettlementPage, object>> = {}): ApiResponseAdminSettlementPage => ({success: faker.datatype.boolean(), data: {content: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({settlementId: faker.number.int(), groupBuyId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), productName: faker.string.alpha({length: {min: 10, max: 20}}), pickupCompletedDate: faker.date.past().toISOString().slice(0, 10), participantCount: faker.number.int(), totalPaymentAmount: faker.number.int(), refundDeductionAmount: faker.number.int(), platformFeeAmount: faker.number.int(), settlementAmount: faker.number.int(), scheduledSettlementDate: faker.date.past().toISOString().slice(0, 10), status: faker.helpers.arrayElement(['SCHEDULED','COMPLETED'] as const), actionable: faker.datatype.boolean()})), totalElements: faker.number.int(), totalPages: faker.number.int(), number: faker.number.int(), size: faker.number.int()}, error: {}, ...overrideResponse})

export const getGetApiV1AdminSettlementsSettlementIdResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminSettlementDetail, object>> = {}): ApiResponseAdminSettlementDetail => ({success: faker.datatype.boolean(), data: {...{settlementId: faker.number.int(), groupBuyId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), productName: faker.string.alpha({length: {min: 10, max: 20}}), pickupCompletedDate: faker.date.past().toISOString().slice(0, 10), participantCount: faker.number.int(), totalPaymentAmount: faker.number.int(), refundDeductionAmount: faker.number.int(), platformFeeAmount: faker.number.int(), settlementAmount: faker.number.int(), scheduledSettlementDate: faker.date.past().toISOString().slice(0, 10), status: faker.helpers.arrayElement(['SCHEDULED','COMPLETED'] as const), actionable: faker.datatype.boolean()},}, error: {}, ...overrideResponse})
...
export const getGetApiV1AdminDashboardUnconfirmedOrdersMockHandler = (overrideResponse?: ApiResponseAdminDashboardUnconfirmedOrders | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminDashboardUnconfirmedOrders> | ApiResponseAdminDashboardUnconfirmedOrders), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/dashboard/unconfirmed-orders', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getGetApiV1AdminDashboardUrgentRefundsMockHandler = (overrideResponse?: ApiResponseAdminDashboardUrgentRefunds | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminDashboardUrgentRefunds> | ApiResponseAdminDashboardUrgentRefunds), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/dashboard/urgent-refunds', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getGetApiV1AdminOrdersOrderIdMockHandler = (overrideResponse?: ApiResponseAdminOrderDetail | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminOrderDetail> | ApiResponseAdminOrderDetail), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/orders/:orderId', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getPostApiV1AdminOrdersOrderIdOwnerContactMockHandler = (overrideResponse?: ApiResponseAdminOrderDetail | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOrderDetail> | ApiResponseAdminOrderDetail), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/orders/:orderId/owner-contact', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getPostApiV1AdminOrdersOrderIdConfirmMockHandler = (overrideResponse?: ApiResponseAdminOrderDetail | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOrderDetail> | ApiResponseAdminOrderDetail), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/orders/:orderId/confirm', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getPostApiV1AdminOrdersOrderIdCancelMockHandler = (overrideResponse?: ApiResponseAdminOrderDetail | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOrderDetail> | ApiResponseAdminOrderDetail), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/orders/:orderId/cancel', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getGetApiV1AdminCsTicketsMockHandler = (overrideResponse?: ApiResponseAdminCsTicketPage | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminCsTicketPage> | ApiResponseAdminCsTicketPage), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/cs-tickets', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getGetApiV1AdminCsTicketsTicketIdMockHandler = (overrideResponse?: ApiResponseAdminCsTicketDetail | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminCsTicketDetail> | ApiResponseAdminCsTicketDetail), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/cs-tickets/:ticketId', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getPatchApiV1AdminCsTicketsTicketIdMockHandler = (overrideResponse?: ApiResponseAdminCsTicketDetail | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<ApiResponseAdminCsTicketDetail> | ApiResponseAdminCsTicketDetail), options?: RequestHandlerOptions) => {
  return http.patch('*/api/v1/admin/cs-tickets/:ticketId', async (info: Parameters<Parameters<typeof http.patch>[1]>[0]) => {
...
export const getPostApiV1AdminOwnerGroupBuysGroupBuyIdCloseRequestsApproveMockHandler = (overrideResponse?: ApiResponseAdminOwnerGroupBuyCloseRequestAction | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOwnerGroupBuyCloseRequestAction> | ApiResponseAdminOwnerGroupBuyCloseRequestAction), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/owner-group-buys/:groupBuyId/close-requests/approve', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getPostApiV1AdminOwnerGroupBuysGroupBuyIdCloseRequestsRejectMockHandler = (overrideResponse?: ApiResponseAdminOwnerGroupBuyCloseRequestAction | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOwnerGroupBuyCloseRequestAction> | ApiResponseAdminOwnerGroupBuyCloseRequestAction), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/owner-group-buys/:groupBuyId/close-requests/reject', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getGetApiV1AdminOwnerGroupBuyRequestsMockHandler = (overrideResponse?: ApiResponseAdminOwnerGroupBuyRequestPage | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminOwnerGroupBuyRequestPage> | ApiResponseAdminOwnerGroupBuyRequestPage), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/owner-group-buy-requests', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getGetApiV1AdminOwnerGroupBuyRequestsRequestIdMockHandler = (overrideResponse?: ApiResponseAdminOwnerGroupBuyRequestDetail | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminOwnerGroupBuyRequestDetail> | ApiResponseAdminOwnerGroupBuyRequestDetail), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/owner-group-buy-requests/:requestId', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getPostApiV1AdminOwnerGroupBuyRequestsRequestIdApproveMockHandler = (overrideResponse?: ApiResponseAdminOwnerGroupBuyRequestAction | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOwnerGroupBuyRequestAction> | ApiResponseAdminOwnerGroupBuyRequestAction), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/owner-group-buy-requests/:requestId/approve', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getPostApiV1AdminOwnerGroupBuyRequestsRequestIdRejectMockHandler = (overrideResponse?: ApiResponseAdminOwnerGroupBuyRequestAction | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseAdminOwnerGroupBuyRequestAction> | ApiResponseAdminOwnerGroupBuyRequestAction), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/admin/owner-group-buy-requests/:requestId/reject', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getGetApiV1AdminSettlementsDashboardMockHandler = (overrideResponse?: ApiResponseAdminSettlementDashboard | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminSettlementDashboard> | ApiResponseAdminSettlementDashboard), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/settlements/dashboard', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getGetApiV1AdminSettlementsMockHandler = (overrideResponse?: ApiResponseAdminSettlementPage | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminSettlementPage> | ApiResponseAdminSettlementPage), options?: RequestHandlerOptions) => {
...
export const getGetApiV1AdminSettlementsSettlementIdMockHandler = (overrideResponse?: ApiResponseAdminSettlementDetail | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseAdminSettlementDetail> | ApiResponseAdminSettlementDetail), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/admin/settlements/:settlementId', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
