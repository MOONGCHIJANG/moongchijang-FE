  ...
  data: faker.helpers.arrayElement([
    {
      ...
      detectedRegion: faker.helpers.arrayElement([
        faker.helpers.arrayElement([
          faker.string.alpha({ length: { min: 10, max: 20 } }),
          null,
        ]),
      ...
      detectedProduct: faker.helpers.arrayElement([
        faker.helpers.arrayElement([
          faker.string.alpha({ length: { min: 10, max: 20 } }),
          null,
        ]),
      ...
      uiState: faker.helpers.arrayElement([
        'RESULTS',
        'EMPTY_CAN_REQUEST',
        'NEED_REGION',
        'NEED_PRODUCT',
      ...
      recommendedStores: faker.helpers.arrayElement([
        Array.from(
          { length: faker.number.int({ min: 1, max: 10 }) },
          (_, i) => i + 1,
        ).map(() => ({
