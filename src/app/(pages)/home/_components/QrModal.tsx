      ...
      >
        ...
        <div className="w-[342px] bg-surface-white rounded-3xlarge shadow-2xl overflow-hidden">
          ...
          >
            <div className="px-5 pt-4 pb-5 flex flex-col gap-3.5 border-b border-dashed border-border-default">
              <div className="flex items-center gap-2">
                <span className="bg-brand-primary text-text-basic-inverse text-sm-medium font-bold font-pretendard w-[41px] h-5 flex items-center justify-center rounded-max">
                  {dDayText}
                </span>
                <span className="text-text-basic text-sm-bold font-pretendard">
                  {storeName}
                </span>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-text-basic text-sm-semibold font-pretendard">
                    예약 번호
                  </span>
                  <span className="text-text-subtle text-sm-regular font-pretendard">
                    {orderNumber}
                  </span>
                </div>
                <div className="flex justify-between items-start gap-4">
                  <span className="text-text-basic text-sm-semibold font-pretendard shrink-0">
                    픽업 장소
                  </span>
                  <span className="text-text-subtle text-sm-regular font-pretendard text-right break-keep">
              ...
              <button className="self-end bg-surface-brand-lighter text-text-brand text-sm-medium font-bold font-pretendard w-[90px] h-7 flex items-center justify-center rounded-xlarge">
                자세히 보기 →
              </button>
            </div>
          </div>
          ...
          <div className="px-5 py-6 flex flex-col items-center gap-3">
            ...
            <p
              className={cn(
                'text-text-subtle text-sm-medium font-bold font-pretendard text-center transition-all duration-300 overflow-hidden',
