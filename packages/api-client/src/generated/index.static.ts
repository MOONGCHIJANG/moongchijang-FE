...
export const generatedStaticMockEntries: StaticMockEntry[] = [
  ...
  { urlPattern: '/api/v1/admin/dashboard/unconfirmed-orders', getResponseData: getGetApiV1AdminDashboardUnconfirmedOrdersResponseMock },
  { urlPattern: '/api/v1/admin/dashboard/urgent-refunds', getResponseData: getGetApiV1AdminDashboardUrgentRefundsResponseMock },
  { urlPattern: '/api/v1/admin/orders', getResponseData: getGetApiV1AdminOrdersResponseMock },
  { urlPattern: '/api/v1/admin/orders/:orderId', getResponseData: getGetApiV1AdminOrdersOrderIdResponseMock },
  { urlPattern: '/api/v1/admin/cs-tickets', getResponseData: getGetApiV1AdminCsTicketsResponseMock },
  { urlPattern: '/api/v1/admin/cs-tickets/:ticketId', getResponseData: getGetApiV1AdminCsTicketsTicketIdResponseMock },
  ...
  { urlPattern: '/api/v1/owner/settlements/items', getResponseData: getGetApiV1OwnerSettlementsItemsResponseMock },
