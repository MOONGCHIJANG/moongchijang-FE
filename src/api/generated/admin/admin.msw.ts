...
export const getGetApiV1AdminSummaryResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminDashboardSummary, object>> = {}): ApiResponseAdminDashboardSummary => ({success: faker.datatype.boolean(), data: {pendingRequestCount: faker.number.int(), activeGroupBuyCount: faker.number.int(), achievementRate: faker.number.float({fractionDigits: 2}), pendingRefundCount: faker.number.int()}, error: {}, ...overrideResponse})

export const getGetApiV1AdminGroupBuyRequestsResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminRequestPage, object>> = {}): ApiResponseAdminRequestPage => ({success: faker.datatype.boolean(), data: {content: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({requestId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), productName: faker.string.alpha({length: {min: 10, max: 20}}), desiredQuantity: faker.number.int(), desiredPickupDate: faker.date.past().toISOString().slice(0, 10), status: faker.helpers.arrayElement(['IN_REVIEW','IN_CONTACT','OPENED','REJECTED'] as const), requesterName: faker.string.alpha({length: {min: 10, max: 20}}), createdAt: faker.date.past().toISOString().slice(0, 19) + 'Z'})), totalElements: faker.number.int(), totalPages: faker.number.int()}, error: {}, ...overrideResponse})

export const getGetApiV1AdminGroupBuyRequestsRequestIdResponseMock = (overrideResponse: Partial<Extract<ApiResponseAdminRequestDetail, object>> = {}): ApiResponseAdminRequestDetail => ({success: faker.datatype.boolean(), data: {requestId: faker.number.int(), storeName: faker.string.alpha({length: {min: 10, max: 20}}), productName: faker.string.alpha({length: {min: 10, max: 20}}), desiredQuantity: faker.number.int(), desiredPickupDate: faker.date.past().toISOString().slice(0, 10), additionalNote: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), null]), status: faker.helpers.arrayElement(['IN_REVIEW','IN_CONTACT','OPENED','REJECTED'] as const), contactPhone: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), null]), contactInstagram: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), null]), rejectionReason: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), null]), requesterName: faker.string.alpha({length: {min: 10, max: 20}}), createdAt: faker.date.past().toISOString().slice(0, 19) + 'Z'}, error: {}, ...overrideResponse})

export const getPatchApiV1AdminGroupBuyRequestsRequestIdStatusResponseMock = (overrideResponse: Partial<Extract<SuccessNoDataResponse, object>> = {}): SuccessNoDataResponse => ({success: faker.datatype.boolean(), data: {}, error: {}, ...overrideResponse})
...
export const getPatchApiV1AdminGroupBuyRequestsRequestIdStatusMockHandler = (overrideResponse?: SuccessNoDataResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<SuccessNoDataResponse> | SuccessNoDataResponse), options?: RequestHandlerOptions) => {
