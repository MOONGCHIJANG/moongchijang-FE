...
export const getGetApiV1StoresSearchResponseMock = (overrideResponse: Partial<Extract<ApiResponseStoreSearchList, object>> = {}): ApiResponseStoreSearchList => ({success: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), data: faker.helpers.arrayElement([{stores: faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({placeId: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), storeName: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), roadAddress: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), lotAddress: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined]), latitude: faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}), undefined]), longitude: faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}), undefined]), imageUrl: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), undefined])})), undefined])}, undefined]), error: faker.helpers.arrayElement([{}, null]), ...overrideResponse})
...
export const getGetApiV1StoresSearchMockHandler = (overrideResponse?: ApiResponseStoreSearchList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseStoreSearchList> | ApiResponseStoreSearchList), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/stores/search', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getPostApiV1GroupBuyRequestsMockHandler = (overrideResponse?: ApiResponseRequestId | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ApiResponseRequestId> | ApiResponseRequestId), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/group-buy-requests', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
...
export const getGetApiV1GroupBuyRequestsMockHandler = (overrideResponse?: ApiResponseGroupBuyRequestList | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseGroupBuyRequestList> | ApiResponseGroupBuyRequestList), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/group-buy-requests', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
...
export const getGetApiV1GroupBuyRequestsRequestIdMockHandler = (overrideResponse?: ApiResponseGroupBuyRequestDetail | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ApiResponseGroupBuyRequestDetail> | ApiResponseGroupBuyRequestDetail), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/group-buy-requests/:requestId', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
