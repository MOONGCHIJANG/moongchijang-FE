...
export const getPostApiV1AuthAdminEmailLoginMutationOptions = <
...
export type PostApiV1AuthAdminEmailLoginMutationResult = NonNullable<
  Awaited<ReturnType<typeof postApiV1AuthAdminEmailLogin>>
>;
export type PostApiV1AuthAdminEmailLoginMutationBody = EmailLoginRequest;
export type PostApiV1AuthAdminEmailLoginMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | ForbiddenResponse;
 ...
 * @summary 관리자 이메일 로그인
 */
export const usePostApiV1AuthAdminEmailLogin = <
  TError = BadRequestResponse | UnauthorizedResponse | ForbiddenResponse,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getPostApiV1AuthAdminEmailLoginMutationOptions(options),
    queryClient,
  );
};
