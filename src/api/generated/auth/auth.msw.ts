...
export const getDeleteApiV1UsersMeRoleResponseMock = (overrideResponse: Partial<Extract<SuccessNoDataResponse, object>> = {}): SuccessNoDataResponse => ({success: faker.datatype.boolean(), data: {}, error: {}, ...overrideResponse})
...
export const getDeleteApiV1UsersMeRoleMockHandler = (overrideResponse?: SuccessNoDataResponse | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<SuccessNoDataResponse> | SuccessNoDataResponse), options?: RequestHandlerOptions) => {
  return http.delete('*/api/v1/users/me/role', async (info: Parameters<Parameters<typeof http.delete>[1]>[0]) => {
