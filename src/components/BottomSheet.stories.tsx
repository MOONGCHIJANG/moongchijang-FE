      ...
      <div className="p-4">
        ...
        <BottomSheet isOpen={isOpen} onClose={() => setIsOpen(false)}>
          <div className="p-6">
            ...
            <p className="text-sm-regular text-text-tertiary mb-6">
              바텀시트 내용이 여기에 들어갑니다.
            </p>
      ...
      <div className="p-4">
        ...
        <BottomSheet isOpen={isOpen} onClose={() => setIsOpen(false)}>
          <div className="p-6">
            ...
            <p className="text-sm-regular text-text-tertiary mb-2">
              상단 핸들 바를 아래로 끌어내려 보세요.
            </p>
            <ul className="text-sm-regular text-text-tertiary mb-6 list-disc pl-5 space-y-1">
