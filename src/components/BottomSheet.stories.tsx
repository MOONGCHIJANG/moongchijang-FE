    ...
    return (
      <div className="p-4">
        ...
        <BottomSheet isOpen={isOpen} onClose={() => setIsOpen(false)}>
          <div className="p-6">
            <h2 className="body-md-bold mb-4">바텀시트 제목</h2>
            <p className="body-sm-regular text-text-tertiary mb-6">
              바텀시트 내용이 여기에 들어갑니다.
            </p>
  ...
  render: () => {
    ...
    return (
      <div className="p-4">
        ...
        <BottomSheet isOpen={isOpen} onClose={() => setIsOpen(false)}>
          <div className="p-6">
            <h2 className="body-md-bold mb-4">드래그로 닫기</h2>
            <p className="body-sm-regular text-text-tertiary mb-2">
              상단 핸들 바를 아래로 끌어내려 보세요.
            </p>
            <ul className="body-sm-regular text-text-tertiary mb-6 list-disc pl-5 space-y-1">
