...
export const getPostApiV1AuthKakaoResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseAuthLogin, object>> = {},
): ApiResponseAuthLogin => ({
  ...
  data: {
    ...
    user: {
      id: faker.number.int(),
      provider: faker.helpers.arrayElement(['KAKAO', 'EMAIL'] as const),
      ...
      role: faker.helpers.arrayElement(['BUYER', 'SELLER', 'ADMIN'] as const),
      lastRole: faker.helpers.arrayElement([
        faker.helpers.arrayElement([
          faker.helpers.arrayElement(['BUYER', 'SELLER', 'ADMIN'] as const),
          null,
        ]),
        undefined,
      ]),
      hasBuyerRole: faker.helpers.arrayElement([
        faker.datatype.boolean(),
        undefined,
      ]),
      hasSellerRole: faker.helpers.arrayElement([
        faker.datatype.boolean(),
        undefined,
      ]),
      canSwitchToBuyer: faker.helpers.arrayElement([
        faker.datatype.boolean(),
        undefined,
      ]),
      canSwitchToSeller: faker.helpers.arrayElement([
        faker.datatype.boolean(),
        undefined,
      ]),
...
export const getPostApiV1AuthRefreshResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseAccessToken, object>> = {},
): ApiResponseAccessToken => ({
  success: faker.datatype.boolean(),
  data: {
    accessToken: faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getGetApiV1UsersMeWithdrawalContextResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseWithdrawalContext, object>> = {},
): ApiResponseWithdrawalContext => ({
  success: faker.datatype.boolean(),
  data: {
    ...
    buyer: {
      canProceed: faker.datatype.boolean(),
      hasPendingPickup: faker.datatype.boolean(),
      hasActiveParticipation: faker.datatype.boolean(),
      blockingReason: faker.helpers.arrayElement(
        Object.values(BuyerWithdrawalBlockingReason),
      ),
    },
    seller: {
      canProceed: faker.datatype.boolean(),
      hasOpenGroupBuy: faker.datatype.boolean(),
      hasPendingCustomerPickup: faker.datatype.boolean(),
      blockingReason: faker.helpers.arrayElement(
        Object.values(SellerWithdrawalBlockingReason),
      ),
    },
    recommendedScreen: faker.helpers.arrayElement(
      Object.values(WithdrawalScreenType),
    ),
    forceRedirect: faker.datatype.boolean(),
    forceRedirectTarget: faker.helpers.arrayElement([
      faker.helpers.arrayElement(Object.values(WithdrawalScreenType)),
      null,
    ]),
  },
  error: {},
...
export const getGetApiV1UsersNicknameAvailabilityResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseNicknameAvailability, object>
  > = {},
): ApiResponseNicknameAvailability => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getPatchApiV1UsersMeAdditionalInfoResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseAdditionalInfoUpdated, object>
  > = {},
): ApiResponseAdditionalInfoUpdated => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getGetApiV1UsersMeSellerSettlementAccountResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseSellerSettlementAccount, object>
  > = {},
): ApiResponseSellerSettlementAccount => ({
  success: faker.datatype.boolean(),
  data: {
    bankCode: faker.string.alpha({ length: { min: 10, max: 20 } }),
    accountNumber: faker.string.alpha({ length: { min: 10, max: 20 } }),
    accountHolderName: faker.string.alpha({ length: { min: 10, max: 20 } }),
  },
  error: {},
  ...overrideResponse,
});

export const getPatchApiV1UsersMeSellerSettlementAccountResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseSellerSettlementAccount, object>
  > = {},
): ApiResponseSellerSettlementAccount => ({
...
export const getGetApiV1UsersMeSellerBusinessProfileResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseSellerBusinessProfile, object>
  > = {},
): ApiResponseSellerBusinessProfile => ({
  success: faker.datatype.boolean(),
  data: {
    ...
    ownerName: faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getPatchApiV1UsersMeSellerBusinessProfileResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseSellerBusinessProfile, object>
  > = {},
): ApiResponseSellerBusinessProfile => ({
...
export const getDeleteApiV1UsersMeSellerResponseMock = (
  overrideResponse: Partial<Extract<SuccessNoDataResponse, object>> = {},
): SuccessNoDataResponse => ({
  success: faker.datatype.boolean(),
  data: {},
...
export const getGetApiV1AuthEmailAvailabilityResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseEmailAvailability, object>> = {},
): ApiResponseEmailAvailability => ({
  success: faker.datatype.boolean(),
  data: { email: faker.internet.email(), available: faker.datatype.boolean() },
  error: {},
  ...overrideResponse,
});
...
export const getPostApiV1AuthEmailVerificationCodesResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseEmailVerificationCodeSent, object>
  > = {},
): ApiResponseEmailVerificationCodeSent => ({
  success: faker.datatype.boolean(),
  data: {
    expiresInSeconds: faker.number.int(),
    resendAvailableInSeconds: faker.number.int(),
    remainingDailyAttempts: faker.number.int(),
  },
  error: {},
  ...overrideResponse,
});
...
export const getPostApiV1AuthEmailVerificationCodesVerifyResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponseEmailVerificationVerified, object>
  > = {},
): ApiResponseEmailVerificationVerified => ({
  success: faker.datatype.boolean(),
  data: {
    verified: faker.datatype.boolean(),
    signupToken: faker.string.alpha({ length: { min: 10, max: 20 } }),
  },
  error: {},
  ...overrideResponse,
});

export const getPostApiV1AuthPhoneVerificationCodesResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponsePhoneVerificationCodeSent, object>
  > = {},
): ApiResponsePhoneVerificationCodeSent => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getPostApiV1AuthPhoneVerificationCodesVerifyResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponsePhoneVerificationVerified, object>
  > = {},
): ApiResponsePhoneVerificationVerified => ({
  success: faker.datatype.boolean(),
  data: { verified: faker.datatype.boolean() },
  error: {},
  ...overrideResponse,
});
...
export const getPostApiV1AuthEmailLoginResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseAuthLogin, object>> = {},
): ApiResponseAuthLogin => ({
  success: faker.datatype.boolean(),
  data: {
...
export const getPostApiV1UsersMePhoneVerificationCodesResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponsePhoneVerificationCodeSent, object>
  > = {},
): ApiResponsePhoneVerificationCodeSent => ({
...
export const getPostApiV1UsersMePhoneVerificationCodesVerifyResponseMock = (
  overrideResponse: Partial<
    Extract<ApiResponsePhoneVerificationVerified, object>
  > = {},
): ApiResponsePhoneVerificationVerified => ({
...
export const getGetApiV1UsersMeRegionsResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseMyRegions, object>> = {},
): ApiResponseMyRegions => ({
  success: faker.datatype.boolean(),
  data: {
    regions: Array.from(
    ...
    primaryRegion: faker.helpers.arrayElement([
      faker.helpers.arrayElement([
        faker.string.alpha({ length: { min: 10, max: 20 } }),
        null,
      ]),
    ...
    additionalCount: faker.number.int(),
  },
  error: {},
  ...overrideResponse,
});

export const getPutApiV1UsersMeRegionsResponseMock = (
  overrideResponse: Partial<Extract<SuccessNoDataResponse, object>> = {},
): SuccessNoDataResponse => ({
  success: faker.datatype.boolean(),
  data: {},
...
export const getPostApiV1AuthKakaoMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<ApiResponseAuthLogin> | ApiResponseAuthLogin),
...
export const getPostApiV1AuthRefreshMockHandler = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<ApiResponseAccessToken> | ApiResponseAccessToken),
  options?: RequestHandlerOptions,
) => {
  return http.post(
    '*/api/v1/auth/refresh',
...
export const getGetApiV1UsersMeWithdrawalContextMockHandler = (
  overrideResponse?:
    | ApiResponseWithdrawalContext
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<ApiResponseWithdrawalContext>
        | ApiResponseWithdrawalContext),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getGetApiV1UsersNicknameAvailabilityMockHandler = (
  overrideResponse?:
    | ApiResponseNicknameAvailability
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<ApiResponseNicknameAvailability>
        | ApiResponseNicknameAvailability),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getPatchApiV1UsersMeAdditionalInfoMockHandler = (
  overrideResponse?:
    | ApiResponseAdditionalInfoUpdated
    | ((
        info: Parameters<Parameters<typeof http.patch>[1]>[0],
      ) =>
        | Promise<ApiResponseAdditionalInfoUpdated>
        | ApiResponseAdditionalInfoUpdated),
  options?: RequestHandlerOptions,
) => {
  return http.patch(
...
export const getGetApiV1UsersMeSellerSettlementAccountMockHandler = (
  overrideResponse?:
    | ApiResponseSellerSettlementAccount
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<ApiResponseSellerSettlementAccount>
        | ApiResponseSellerSettlementAccount),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getPatchApiV1UsersMeSellerSettlementAccountMockHandler = (
  overrideResponse?:
    | ApiResponseSellerSettlementAccount
    | ((
        info: Parameters<Parameters<typeof http.patch>[1]>[0],
...
export const getGetApiV1UsersMeSellerBusinessProfileMockHandler = (
  overrideResponse?:
    | ApiResponseSellerBusinessProfile
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<ApiResponseSellerBusinessProfile>
        | ApiResponseSellerBusinessProfile),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getPatchApiV1UsersMeSellerBusinessProfileMockHandler = (
  overrideResponse?:
    | ApiResponseSellerBusinessProfile
    | ((
        info: Parameters<Parameters<typeof http.patch>[1]>[0],
...
export const getDeleteApiV1UsersMeSellerMockHandler = (
  overrideResponse?:
    | SuccessNoDataResponse
    | ((
        info: Parameters<Parameters<typeof http.delete>[1]>[0],
...
export const getGetApiV1AuthEmailAvailabilityMockHandler = (
  overrideResponse?:
    | ApiResponseEmailAvailability
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<ApiResponseEmailAvailability>
        | ApiResponseEmailAvailability),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getPostApiV1AuthEmailVerificationCodesMockHandler = (
  overrideResponse?:
    | ApiResponseEmailVerificationCodeSent
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) =>
        | Promise<ApiResponseEmailVerificationCodeSent>
        | ApiResponseEmailVerificationCodeSent),
  options?: RequestHandlerOptions,
) => {
  return http.post(
...
export const getPostApiV1AuthEmailVerificationCodesVerifyMockHandler = (
  overrideResponse?:
    | ApiResponseEmailVerificationVerified
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) =>
        | Promise<ApiResponseEmailVerificationVerified>
        | ApiResponseEmailVerificationVerified),
  options?: RequestHandlerOptions,
) => {
  return http.post(
...
export const getPostApiV1AuthPhoneVerificationCodesMockHandler = (
  overrideResponse?:
    | ApiResponsePhoneVerificationCodeSent
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) =>
        | Promise<ApiResponsePhoneVerificationCodeSent>
        | ApiResponsePhoneVerificationCodeSent),
  options?: RequestHandlerOptions,
) => {
  return http.post(
...
export const getPostApiV1AuthPhoneVerificationCodesVerifyMockHandler = (
  overrideResponse?:
    | ApiResponsePhoneVerificationVerified
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) =>
        | Promise<ApiResponsePhoneVerificationVerified>
        | ApiResponsePhoneVerificationVerified),
  options?: RequestHandlerOptions,
) => {
  return http.post(
...
export const getPostApiV1AuthEmailSignupMockHandler = (
  overrideResponse?:
    | ApiResponseAuthLogin
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
...
export const getPostApiV1AuthEmailLoginMockHandler = (
  overrideResponse?:
    | ApiResponseAuthLogin
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
...
export const getPostApiV1UsersMePhoneVerificationCodesMockHandler = (
  overrideResponse?:
    | ApiResponsePhoneVerificationCodeSent
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
  ...
  return http.post(
    '*/api/v1/users/me/phone/verification-codes',
    async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
      return HttpResponse.json(
        overrideResponse !== undefined
          ? typeof overrideResponse === 'function'
...
export const getPostApiV1UsersMePhoneVerificationCodesVerifyMockHandler = (
  overrideResponse?:
    | ApiResponsePhoneVerificationVerified
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
  ...
  return http.post(
    '*/api/v1/users/me/phone/verification-codes/verify',
    async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
      return HttpResponse.json(
        overrideResponse !== undefined
          ? typeof overrideResponse === 'function'
...
export const getGetApiV1UsersMeRegionsMockHandler = (
  overrideResponse?:
    | ApiResponseMyRegions
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<ApiResponseMyRegions> | ApiResponseMyRegions),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getPutApiV1UsersMeRegionsMockHandler = (
  overrideResponse?:
    | SuccessNoDataResponse
    | ((
