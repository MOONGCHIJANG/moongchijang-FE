...
export const getPostApiV1ImagesPresignedUrlsMutationOptions = <
...
export type PostApiV1ImagesPresignedUrlsMutationResult = NonNullable<
  Awaited<ReturnType<typeof postApiV1ImagesPresignedUrls>>
>;
export type PostApiV1ImagesPresignedUrlsMutationBody =
  ImagePresignedUploadRequest;
export type PostApiV1ImagesPresignedUrlsMutationError =
  | BadRequestResponse
  | UnauthorizedResponse;
 ...
 * @summary S3 이미지 업로드용 Presigned URL 발급
 */
export const usePostApiV1ImagesPresignedUrls = <
  TError = BadRequestResponse | UnauthorizedResponse,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getPostApiV1ImagesPresignedUrlsMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getDeleteApiV1ImagesMutationOptions = <
  TError = BadRequestResponse | UnauthorizedResponse,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteApiV1ImagesMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteApiV1Images>>
>;
export type DeleteApiV1ImagesMutationBody = ImageDeleteRequest;
export type DeleteApiV1ImagesMutationError =
  | BadRequestResponse
  | UnauthorizedResponse;
 ...
 * @summary S3 업로드 이미지 삭제
 */
export const useDeleteApiV1Images = <
  TError = BadRequestResponse | UnauthorizedResponse,
  TContext = unknown,
>(
  options?: {
