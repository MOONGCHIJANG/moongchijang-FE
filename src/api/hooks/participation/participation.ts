...
export const getGetApiV1GroupBuysGroupBuyIdCheckoutQueryKey = (groupBuyId: number,
    params?: GetApiV1GroupBuysGroupBuyIdCheckoutParams,) => {
    return [
    `/api/v1/group-buys/${groupBuyId}/checkout`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetApiV1GroupBuysGroupBuyIdCheckoutQueryOptions = <TData = Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>, TError = BadRequestResponse | ConflictResponse>(groupBuyId: number,
    params: GetApiV1GroupBuysGroupBuyIdCheckoutParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiV1GroupBuysGroupBuyIdCheckoutQueryKey(groupBuyId,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>> = ({ signal }) => getApiV1GroupBuysGroupBuyIdCheckout(groupBuyId,params, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(groupBuyId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiV1GroupBuysGroupBuyIdCheckoutQueryResult = NonNullable<Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>>
export type GetApiV1GroupBuysGroupBuyIdCheckoutQueryError = BadRequestResponse | ConflictResponse


export function useGetApiV1GroupBuysGroupBuyIdCheckout<TData = Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>, TError = BadRequestResponse | ConflictResponse>(
 groupBuyId: number,
    params: GetApiV1GroupBuysGroupBuyIdCheckoutParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetApiV1GroupBuysGroupBuyIdCheckout<TData = Awaited<ReturnType<typeof getApiV1GroupBuysGroupBuyIdCheckout>>, TError = BadRequestResponse | ConflictResponse>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getGetApiV1GroupBuysGroupBuyIdCheckoutQueryOptions(groupBuyId,params,options)
...
export const getPostApiV1GroupBuysGroupBuyIdPaymentOrdersMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1GroupBuysGroupBuyIdPaymentOrders>>, TError,{groupBuyId: number;data: PaymentOrderCreate}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1GroupBuysGroupBuyIdPaymentOrders>>, TError,{groupBuyId: number;data: PaymentOrderCreate}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1GroupBuysGroupBuyIdPaymentOrders>>, {groupBuyId: number;data: PaymentOrderCreate}> = (props) => {
          const {groupBuyId,data} = props ?? {};

          return  postApiV1GroupBuysGroupBuyIdPaymentOrders(groupBuyId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1GroupBuysGroupBuyIdPaymentOrdersMutationResult = NonNullable<Awaited<ReturnType<typeof postApiV1GroupBuysGroupBuyIdPaymentOrders>>>
    export type PostApiV1GroupBuysGroupBuyIdPaymentOrdersMutationBody = PaymentOrderCreate
    export type PostApiV1GroupBuysGroupBuyIdPaymentOrdersMutationError = BadRequestResponse | UnauthorizedResponse | ConflictResponse

    /**
 * @summary PortOne 결제 주문 생성
 */
export const usePostApiV1GroupBuysGroupBuyIdPaymentOrders = <TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1GroupBuysGroupBuyIdPaymentOrders>>, TError,{groupBuyId: number;data: PaymentOrderCreate}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostApiV1GroupBuysGroupBuyIdPaymentOrdersMutationOptions(options), queryClient);
    }
    /**
...
export const getPostApiV1PaymentsPortoneCompleteMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1PaymentsPortoneComplete>>, TError,{data: PaymentConfirm}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1PaymentsPortoneComplete>>, TError,{data: PaymentConfirm}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1PaymentsPortoneComplete>>, {data: PaymentConfirm}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1PaymentsPortoneCompleteMutationResult = NonNullable<Awaited<ReturnType<typeof postApiV1PaymentsPortoneComplete>>>
    export type PostApiV1PaymentsPortoneCompleteMutationBody = PaymentConfirm
    export type PostApiV1PaymentsPortoneCompleteMutationError = BadRequestResponse | UnauthorizedResponse | ConflictResponse

    /**
 * @summary PortOne 결제 완료 서버 검증
 */
export const usePostApiV1PaymentsPortoneComplete = <TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1PaymentsPortoneComplete>>, TError,{data: PaymentConfirm}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getPostApiV1PaymentsPortoneWebhookMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1PaymentsPortoneWebhook>>, TError,{data: PortOneWebhook}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1PaymentsPortoneWebhook>>, TError,{data: PortOneWebhook}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1PaymentsPortoneWebhook>>, {data: PortOneWebhook}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1PaymentsPortoneWebhookMutationResult = NonNullable<Awaited<ReturnType<typeof postApiV1PaymentsPortoneWebhook>>>
 ...
 * @summary PortOne 결제 웹훅 수신
 */
export const usePostApiV1PaymentsPortoneWebhook = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1PaymentsPortoneWebhook>>, TError,{data: PortOneWebhook}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostApiV1PaymentsPortoneWebhookMutationOptions(options), queryClient);
    }
    /**
...
export const getPostApiV1ParticipationsParticipationIdCancelMutationOptions = <TError = UnauthorizedResponse | ForbiddenResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1ParticipationsParticipationIdCancel>>, TError,{participationId: number;data: CancelParticipationRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1ParticipationsParticipationIdCancel>>, TError,{participationId: number;data: CancelParticipationRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1ParticipationsParticipationIdCancel>>, {participationId: number;data: CancelParticipationRequest}> = (props) => {
          const {participationId,data} = props ?? {};

          return  postApiV1ParticipationsParticipationIdCancel(participationId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1ParticipationsParticipationIdCancelMutationResult = NonNullable<Awaited<ReturnType<typeof postApiV1ParticipationsParticipationIdCancel>>>
    export type PostApiV1ParticipationsParticipationIdCancelMutationBody = CancelParticipationRequest
    export type PostApiV1ParticipationsParticipationIdCancelMutationError = UnauthorizedResponse | ForbiddenResponse | ConflictResponse

    /**
 * @summary 참여 취소 (달성 전 이탈)
 */
export const usePostApiV1ParticipationsParticipationIdCancel = <TError = UnauthorizedResponse | ForbiddenResponse | ConflictResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1ParticipationsParticipationIdCancel>>, TError,{participationId: number;data: CancelParticipationRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostApiV1ParticipationsParticipationIdCancelMutationOptions(options), queryClient);
    }
